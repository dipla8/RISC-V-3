...
always @(*) begin
	...
	if (exmem_regwrite == 1'b1 && exmem_rd == idex_rs2/* && exmem_reg_type == idex_reg_type*/) begin // needs adjustment so that different type forwarding doesnt happen except for the case that there are rd of the same type.
		bypassB = 2'b10; // Forward data from EX/MEM stage
	end
